<template>
  <div class="min-h-screen bg-white">
    ...
    <div class="w-full bg-[#eaf2f3] py-12">
      <div class="max-w-6xl mx-auto flex flex-col md:flex-row gap-8 px-4">
        ...
        <div class="flex-1 flex flex-col justify-center">
          <div class="text-[#6b7a8f] text-sm mb-2">YOUR PATH TO FLUENCY</div>
          <div class="text-5xl font-bold mb-6">HSK 1-6<br>Lessons</div>
          <!-- 课程图片区域（留空，后续可填充图片） -->
          <div class="w-full h-64 bg-white flex items-center justify-center border border-gray-200 rounded mb-6">
            <!-- 你可以在这里插入图片 -->
            <span class="text-gray-300">课程图片区域</span>
          </div>
          <button class="bg-[#6ec1e4] text-white px-6 py-2 rounded font-semibold hover:bg-[#009FE8] transition">book now</button>
        </div>
        <!-- 右侧介绍 -->
        <div class="flex-1">
          <div class="text-[#2d3a4a] font-semibold mb-2">Living In China</div>
    ...
    <!-- FAQ 区域 -->
    <div class="w-full bg-cover bg-center py-16" style="background-image: url('/images/faq_bg.jpg');">
      <div class="max-w-6xl mx-auto px-4">
        ...
        <div class="grid md:grid-cols-3 gap-8 text-white">
          <div>
            <div class="font-bold mb-2">WHAT IS THE HSK, AND WHY IS IT IMPORTANT?</div>
            <div class="text-sm">
          ...
          <div>
            <div class="font-bold mb-2">HOW LONG DOES IT TAKE TO PREPARE FOR AN HSK EXAM?</div>
            <div class="text-sm">
          ...
          <div>
            <div class="font-bold mb-2">HOW ARE YOUR LESSONS STRUCTURED FOR DIFFERENT HSK LEVELS?</div>
            <div class="text-sm">
          ...
          <div>
            <div class="font-bold mb-2">DO YOU PROVIDE HSK EXAM PRACTICE TESTS?</div>
            <div class="text-sm">
          ...
          <div>
            <div class="font-bold mb-2">WHAT CAN I EXPECT TO ACHIEVE AFTER COMPLETING EACH HSK LEVEL?</div>
            <div class="text-sm">
          ...
          <div>
            <div class="font-bold mb-2">CAN I START AT ANY HSK LEVEL, OR DO I NEED TO START FROM LEVEL 1?</div>
            <div class="text-sm">
